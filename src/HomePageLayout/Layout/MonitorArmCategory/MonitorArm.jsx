         ...
         300px:overflow-x-scroll whitespace-nowrap no-scrollbar scroll scroll-smooth 768px:overflow-x-hidden"
          >
            <span
              ...
              className={`${active === 1 ? "text-[#077bc4]" : "text-[#242424]"}`}
            >
              Single & Dual
            </span>
            <span
              ...
              className={`${active === 2 ? "text-[#077bc4]" : "text-[#242424]"}`}
            >
            ...
            <span
              ...
              className={`${active === 3 ? "text-[#077bc4]" : "text-[#242424]"}`}>
              Visa Mount Adapter
            </span>
            <span
              onClick={() => {
              ...
              className={`${active === 4 ? "text-[#077bc4]" : "text-[#242424]"}`}
            >
              Others Stand
            </span>
          </div>
            ...
            <div
               >
                   {vdata?.length===0?(
                     ...
                     <div className={`grid grid-cols-2 gap-[3px] 
                     md:grid-cols-4 md:gap-[10px] lg:grid-cols-5 lg:gap-[16px]  xl:grid-cols-6 xl:gap-[4px] 1350px:grid-cols-6 1350px:gap-[10px] monitorProductCard ${
                       isClicked
                         ? "monitorProductCardClicked"
                         : ""
                     }`}>
